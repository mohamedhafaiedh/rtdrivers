...
export const metadata: Metadata = {
  title: "Mentions Légales - RT Drivers",
  description: "Mentions légales Informations générales Nom commercial: Road Trip DriversRaison sociale : DD ServicesForme juridique : SASCapital social : 5.000 €Siège social : 112, avenue de Paris, 94300 VincennesN° Siret : 92783988600011Directeur de la publication : M. Ramzi HadfiTéléphone : +33 (0)6 06 69 44 97E-mail : contact@rtdrivers.fr Propriété intellectuelle et contrefaçons Le propriétaire du site est propriétaire […]",
  alternates: {
...
export default function MentionsLegalesPage() {
  return (
    <body className="wp-singular page-template-default page page-id-11323 wp-custom-logo wp-embed-responsive wp-theme-hello-elementor wp-child-theme-hello-theme-child-master hello-elementor-default elementor-default elementor-kit-80 elementor-page elementor-page-11323">
...
<main id="content" className="site-main post-11323 page type-page status-publish hentry">
<div className="page-content">
<div data-elementor-type="wp-page" data-elementor-id="11323" className="elementor elementor-11323" data-elementor-post-type="page">
<section className="elementor-section elementor-top-section elementor-element elementor-element-b8e2bff elementor-section-boxed elementor-section-height-default elementor-section-height-default" data-id="b8e2bff" data-element_type="section" data-e-type="section">
<div className="elementor-container elementor-column-gap-default">
<div className="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-31c576b" data-id="31c576b" data-element_type="column" data-e-type="column">
<div className="elementor-widget-wrap elementor-element-populated">
<div className="elementor-element elementor-element-c9d7705 elementor-widget elementor-widget-heading" data-id="c9d7705" data-element_type="widget" data-e-type="widget" data-widget_type="heading.default">
<div className="elementor-widget-container">
<h1 className="elementor-heading-title elementor-size-default">Mentions légales</h1> </div>
</div>
<div className="elementor-element elementor-element-35da699 elementor-widget elementor-widget-heading" data-id="35da699" data-element_type="widget" data-e-type="widget" data-widget_type="heading.default">
<div className="elementor-widget-container">
<h3 className="elementor-heading-title elementor-size-default">Informations générales</h3> </div>
</div>
<div className="elementor-element elementor-element-bddab90 elementor-widget elementor-widget-text-editor" data-id="bddab90" data-element_type="widget" data-e-type="widget" data-widget_type="text-editor.default">
<div className="elementor-widget-container">
<p>Nom commercial: Road Trip Drivers<br />Raison sociale : DD Services<br />Forme juridique : SAS<br />Capital social : 5.000 €<br />Siège social : <span style={{ backgroundImage: "initial", backgroundPosition: "initial", backgroundSize: "initial", backgroundRepeat: "initial", backgroundAttachment: "initial", backgroundOrigin: "initial", backgroundClip: "initial" }}>112, avenue de Paris, 94300 Vincennes<br /></span>N° Siret : <span style={{ backgroundImage: "initial", backgroundPosition: "initial", backgroundSize: "initial", backgroundRepeat: "initial", backgroundAttachment: "initial", backgroundOrigin: "initial", backgroundClip: "initial" }}>92783988600011<br /></span>Directeur de la publication : M. Ramzi Hadfi<br />Téléphone : +33 (0)6 06 69 44 97<br />E-mail : contact@rtdrivers.fr</p> </div>
</div>
<div className="elementor-element elementor-element-f4a59d1 elementor-widget elementor-widget-heading" data-id="f4a59d1" data-element_type="widget" data-e-type="widget" data-widget_type="heading.default">
<div className="elementor-widget-container">
<h3 className="elementor-heading-title elementor-size-default">Propriété intellectuelle et contrefaçons
</h3> </div>
</div>
<div className="elementor-element elementor-element-0e9beb3 elementor-widget elementor-widget-text-editor" data-id="0e9beb3" data-element_type="widget" data-e-type="widget" data-widget_type="text-editor.default">
<div className="elementor-widget-container">
<p>Le propriétaire du site est propriétaire des droits de propriété intellectuelle ou détient les droits d’usage sur tous les éléments accessibles sur le site, notamment les textes, images, graphismes, logo, icônes, sons, logiciels…<br /></p> </div>
</div>
<div className="elementor-element elementor-element-823a6d9 elementor-widget elementor-widget-heading" data-id="823a6d9" data-element_type="widget" data-e-type="widget" data-widget_type="heading.default">
<div className="elementor-widget-container">
<h3 className="elementor-heading-title elementor-size-default">Limitation de responsabilité
</h3> </div>
</div>
<div className="elementor-element elementor-element-53cdc39 elementor-widget elementor-widget-text-editor" data-id="53cdc39" data-element_type="widget" data-e-type="widget" data-widget_type="text-editor.default">
<div className="elementor-widget-container">
<p>Vous utilisez ce site sous votre seule et entière responsabilité. Road Trip Drivers ne pourra être tenue pour responsable des dommages directs ou indirects, tels que, notamment, préjudice matériel, pertes de données ou de programmes, préjudice financier, résultant de l’utilisation de ce site ou de sites qui lui sont liés.</p> </div>
</div>
<div className="elementor-element elementor-element-5c00b2c elementor-widget elementor-widget-heading" data-id="5c00b2c" data-element_type="widget" data-e-type="widget" data-widget_type="heading.default">
<div className="elementor-widget-container">
<h3 className="elementor-heading-title elementor-size-default">Hébergeur</h3> </div>
</div>
<div className="elementor-element elementor-element-e0dfc68 elementor-widget elementor-widget-text-editor" data-id="e0dfc68" data-element_type="widget" data-e-type="widget" data-widget_type="text-editor.default">
<div className="elementor-widget-container">
<p><a href="https://www.siteground.com/" target="_blank" rel="noopener">SiteGround Hosting Ltd</a>.</p> </div>
</div>
</div>
</div>
</div>
...
<li className="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-11323 current_page_item menu-item-28410"><a href="/mentions-legales//" aria-current="page" className="elementor-item elementor-item-active">Mentions légales</a></li>
...
<li className="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-11323 current_page_item menu-item-28410"><a href="/mentions-legales//" aria-current="page" className="elementor-item elementor-item-active" tabIndex={-1}>Mentions légales</a></li>
