...
export default function PolitiqueDeCookiesPage() {
  return (
    <body className="privacy-policy wp-singular page-template-default page page-id-12 wp-custom-logo wp-embed-responsive wp-theme-hello-elementor wp-child-theme-hello-theme-child-master hello-elementor-default elementor-default elementor-kit-80 elementor-page elementor-page-12">
